...
- ビクター HC-90 および HC-95 (MSX2) : SRAMから読み出されたデータが化けるため正常動作しない
- 三菱 ML-G30model1 および ML-G30model2: SRAMから読み出されたデータが化けるため正常動作しない
...
- 8086YES! OneChipBook(MSXBOOK) ※ただし似非RAMディスクとしての使用には難あり
